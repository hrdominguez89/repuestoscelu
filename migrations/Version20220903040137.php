 ...
 */
final class Version20220903040137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_condition (id INT NOT NULL, api_id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
