...
class Constants
{
    ...
    const EMAIL_NEW_ORDER_CUSTOMER = 2;
    ...
    const EMAIL_NEW_ORDER_SALE_POINT = 6;
    const EMAIL_TYPE_RESET_PASSWORD_BACKOFFICE = 7;
    const EMAIL_TYPE_WELCOME_BACKOFFICE = 8;
    const EMAIL_ORDER_CONFIRMED_CUSTOMER = 9;
    const EMAIL_ORDER_CANCELED_CUSTOMER = 10;
    const EMAIL_NEW_PAYMENT_FILE = 11;
