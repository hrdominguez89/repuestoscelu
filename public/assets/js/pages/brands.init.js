...
$(document).ready(function () {
  //table
  table = $("#datatable-brands").DataTable({
    columns: [
      {
        data: null,
...
//toggle form
function toggleForm() {
  $(".form-brand,.table-brand").toggle("slide");
}
//end toogle form
...
function getAll() {
  //show table loader
  toogleTableLoader("table-brands-loader");
...
window.onload = function () {
  var form = document.getElementById("form-brand");
