...
$(document).ready(function () {
  //table
  table = $("#datatable-tiempo-demora-almacen").DataTable({
    columns: [
      {
        data: null,
...
//toggle form
function toggleForm() {
  $(".form-tiempo-demora-almacen,.table-tiempo-demora-almacen").toggle("slide");
}
//end toogle form
...
function btnPost() {
  ...
  //clear form
  clearForm($(".form-tiempo-demora-almacen"));
  pristine.reset();
...
function getAll() {
  //show table loader
  toogleTableLoader("table-tiempo-demora-almacen-loader");
...
function post() {
  //get form data
  var formData = $(".form-tiempo-demora-almacen")
    .serializeArray()
...
function put() {
  ...
  send(
    Method.POST,
    "/tiempo-demora-almacen/" + formData.id,
    formData,
    function (response) {
      //reload grid
      getAll();
...
window.onload = function () {
  var form = document.getElementById("form-tiempo-demora-almacen");
